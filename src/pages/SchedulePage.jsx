...
const styles = {
  ...
  catBtn: {
    padding: '8px 12px', background: 'white', border: '1px solid #e0e0e0',
  ...
  navBtn: { background: 'none', border: 'none', fontSize: 16, cursor: 'pointer', padding: '4px 8px' },
  weekLabels: { display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', marginBottom: 4 },
  weekLabel: { textAlign: 'center', fontSize: 11, color: '#aaa', padding: '4px 0' },
  calGrid: { display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: 2 },
  calDay: {
    display: 'flex', flexDirection: 'column', alignItems: 'center',
    padding: '6px 2px', borderRadius: 8, cursor: 'pointer', minHeight: 44,
  },
  calDayToday: { background: '#fff3f0' },
  calDaySelected: { background: '#ff7043', borderRadius: 8 },
  calDayNum: { fontSize: 12, fontWeight: 600, marginBottom: 4 },
  ...
  weekDayLabel: { fontSize: 11, color: '#aaa', marginBottom: 4 },
  weekDayNum: { fontSize: 16, fontWeight: 700, marginBottom: 4 },
  scheduleItem: {
  ...
  scheduleInfo: { flex: 1 },
  scheduleTitle: { fontSize: 14, fontWeight: 600, margin: 0, lineHeight: 1.4 },
  scheduleTime: { fontSize: 12, color: '#aaa', margin: '2px 0 0' },
  scheduleMemo: { fontSize: 12, color: '#888', margin: '4px 0 0' },
  recurringBadge: {
    fontSize: 10, color: '#aaa', background: '#f0f0f0',
  ...
  addForDateBtn: {
    width: '100%', padding: 10, background: '#fff3f0', color: '#ff7043',
    border: '1px dashed #ff7043', borderRadius: 12, fontSize: 13,
  ...
  inputLabel: { fontSize: 13, fontWeight: 600, color: '#555', margin: '8px 0 8px' },
  catRow: { display: 'flex', flexWrap: 'wrap', gap: 8, marginBottom: 12 },
  catItem: {
    padding: '6px 12px', border: '1px solid #e0e0e0',
    borderRadius: 20, background: 'white', fontSize: 13, cursor: 'pointer',
  },
  catItemActive: { background: '#ff7043', color: 'white', border: 'none' },
  recurringRow: { marginBottom: 12 },
  recurringLabel: { fontSize: 14, display: 'flex', alignItems: 'center', marginBottom: 8 },
