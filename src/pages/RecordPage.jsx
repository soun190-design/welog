...
const styles = {
  ...
  toggleBtn: {
    ...
    border: 'none', borderRadius: 25, fontSize: 13, fontWeight: 700,
    cursor: 'pointer', boxShadow: '0 2px 8px rgba(255,107,107,0.30)',
  },
  card: {
    background: '#FDFAF7', borderRadius: 20, marginBottom: 12,
  ...
  label: { fontSize: 14, fontWeight: 600, color: '#5C5049', margin: '16px 0 8px' },
  textarea: {
    width: '100%', minHeight: 80, padding: 12, border: '1px solid #EDE8E3',
    borderRadius: 12, fontSize: 14, resize: 'none', outline: 'none',
    boxSizing: 'border-box', fontFamily: 'inherit', lineHeight: 1.6, background: '#FDFAF7',
  },
  input: {
  ...
  addBtn: {
    width: '100%', padding: 12, background: '#FFF0EE', color: '#FF6B6B',
    border: '1px dashed #FF6B6B', borderRadius: 12, fontSize: 14,
    fontWeight: 600, cursor: 'pointer', marginTop: 4,
  },
  btnRow: { display: 'flex', gap: 8 },
  affirmationCard: { background: '#F5F0EB', borderRadius: 12, padding: 12, marginBottom: 10 },
  affirmationTitle: { fontSize: 13, fontWeight: 600, color: '#5C5049', margin: '0 0 6px' },
  yesterdayText: { fontSize: 12, color: '#B0A69D', margin: '0 0 8px', fontStyle: 'italic' },
  newsLoadBtn: {
    width: '100%', padding: 12, background: '#EDE8E3', color: '#5C5049',
    border: 'none', borderRadius: 12, fontSize: 14, cursor: 'pointer', marginTop: 4,
  },
  newsCard: { background: '#F5F0EB', borderRadius: 12, padding: 12, marginBottom: 10 },
  newsTitle: {
    fontSize: 13, fontWeight: 600, color: '#2D2D2D', textDecoration: 'none',
    display: 'block', marginBottom: 4, lineHeight: 1.5,
  },
  newsSource: { fontSize: 11, color: '#9E9083', margin: '0 0 8px' },
  refreshBtn: {
    width: '100%', padding: 10, background: '#EDE8E3', color: '#9E9083',
  ...
  emptySmall: { color: '#B0A69D', fontSize: 13, textAlign: 'center', padding: '8px 0' },
  recordText: { fontSize: 14, color: '#2D2D2D', lineHeight: 1.6, margin: '8px 0' },
  gratitudeItem: { fontSize: 14, color: '#2D2D2D', margin: '4px 0' },
  timelineBtn: {
    padding: '4px 10px', background: '#FFF0EE', color: '#FF6B6B',
