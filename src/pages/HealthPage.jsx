...
const styles = {
  ...
  emojiBtn: {
    ...
    padding: '8px 4px', border: '1px solid #f0f0f0', borderRadius: 12,
    background: 'white', cursor: 'pointer', gap: 4,
  },
  emojiBtnActive: {
    border: '2px solid #ff7043', background: '#fff3f0',
  },
  emojiIcon: { fontSize: 22 },
  emojiLabel: { fontSize: 9, color: '#aaa' },
  input: {
  ...
  mealLabel: { fontSize: 13, fontWeight: 600, width: 50, flexShrink: 0 },
  mealInput: {
    flex: 1, padding: 10, border: '1px solid #f0f0f0',
    borderRadius: 12, fontSize: 14, outline: 'none', fontFamily: 'inherit',
  },
  exerciseRow: { display: 'flex', alignItems: 'center', gap: 8 },
  exerciseBtn: {
    flex: 1, padding: 14, border: '1px solid #e0e0e0',
    borderRadius: 12, background: 'white', fontSize: 14, cursor: 'pointer',
  },
  exerciseBtnActive: {
    border: 'none', background: '#fff3f0', color: '#ff7043', fontWeight: 600,
  },
  detailToggle: {
  ...
  dotCellToday: { background: '#fff3f0', borderRadius: 8 },
  dotDay: { fontSize: 11, color: '#aaa' },
  ...
  statItem: { flex: 1, textAlign: 'center', padding: 12, background: '#fafaf8', borderRadius: 12 },
  statNum: { fontSize: 24, fontWeight: 800, color: '#ff7043', margin: 0 },
  statLabel: { fontSize: 12, color: '#aaa', margin: '4px 0 0' },
  conditionDisplay: { display: 'flex', alignItems: 'center', gap: 12 },
  conditionEmoji: { fontSize: 32 },
  conditionMemo: { fontSize: 14, color: '#555' },
  mealItem: { fontSize: 14, color: '#333', margin: '4px 0' },
  exerciseStatus: { fontSize: 15, fontWeight: 600, margin: '0 0 4px' },
